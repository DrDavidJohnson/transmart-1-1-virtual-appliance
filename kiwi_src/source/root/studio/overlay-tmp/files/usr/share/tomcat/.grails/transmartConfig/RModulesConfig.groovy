...
RModules 
{
	// plugin script directory
       pluginScriptDirectory = "/srv/tomcat/webapps/transmart/plugins/rdc-rmodules-0.3-SNAPSHOT/Rscripts/"
	   ...
	   temporaryImageFolder = "/srv/tomcat/webapps/transmart/images/tempImages"
